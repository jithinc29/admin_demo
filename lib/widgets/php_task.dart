...
class PhpTask extends StatefulWidget {
 

  @override
  State<PhpTask> createState() => _PhpTaskState();
}

class _PhpTaskState extends State<PhpTask> {
  ...
  _validationtask() {
    ...
    Future _addTasktoFirebase() async {
      ...
      await FirebaseFirestore.instance.collection("admintask").doc("Php").set({
      "id":"Php"
    });
    await FirebaseFirestore.instance.collection("admintask").doc("Php").collection("usertask").add({
