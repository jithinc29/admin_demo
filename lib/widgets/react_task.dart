...
class ReactTask extends StatefulWidget {


  @override
  State<ReactTask> createState() => _ReactTaskState();
}

class _ReactTaskState extends State<ReactTask> {
  ...
  _validationtask() {
    ...
    Future _addTasktoFirebase() async {
      ...
      await FirebaseFirestore.instance.collection("admintask").doc("React").set({
      "id":"React"
    });
    await FirebaseFirestore.instance.collection("admintask").doc("React").collection("usertask").add({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("React"),),
            body: Container(
